...
export function printStudentPDF({ submission, assessment, questions }: { submission: StudentSubmission, assessment: Assessment, questions: Question[] }, hubName?: string): void {
...
export function printAnswerKeyPDF({ assessment, questions }: { assessment: Assessment, questions: Question[] }, hubName?: string): void {
...
export function printProfessorsPDF(professors: ProfessorAccount[], assignments: ProfessorDiscipline[], disciplines: Discipline[], hubName?: string): void {
...
export function printBlankAssessmentPDF({ assessment, questions }: { assessment: Assessment, questions: Question[] }, hubName?: string): void {
    const orderedQuestions = assessment.questionIds.map(id => questions.find(q => q.id === id)).filter(Boolean) as Question[]
    const rows = orderedQuestions.map((q, i) => {
...
export function printOverviewPDF({ assessments, submissions, questions }: { assessments: Assessment[], submissions: StudentSubmission[], questions: Question[] }, hubName?: string): void {
